...
#ifndef START_STOP_BAR_SWIFT_H
#define START_STOP_BAR_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="start_stop_bar",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSApplication;
SWIFT_CLASS("_TtC14start_stop_bar11AppDelegate")
...
SWIFT_CLASS("_TtC14start_stop_bar17MainFlutterWindow")
